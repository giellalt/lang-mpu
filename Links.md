    ...
    * `fst/`
        * `morphology/`
            * `affixes/`
                ...
                * [prefixes.lexc](src-fst-morphology-affixes-prefixes.lexc.html) ([src](https://github.com/giellalt/lang-mpu/blob/main/src/fst/morphology/affixes/prefixes.lexc))
        ...
        * `transcriptions/`
            ...
            * [transcriptor-symbols2text.lexc](src-fst-transcriptions-transcriptor-symbols2text.lexc.html) ([src](https://github.com/giellalt/lang-mpu/blob/main/src/fst/transcriptions/transcriptor-symbols2text.lexc))
* `tools/`
    * `grammarcheckers/`
